...
class TgBot:
    ...
    def from_env(env: Env):
        ...
        return TgBot(token=token, admin_ids=admin_ids, use_redis=use_redis, web_app_url=web_app_url)
...
class CORSConfig:
    ...
    def from_env(env: Env):
        """
        Creates the CORSConfig object from environment variables.
        """
        allow_origins = env.list("CORS_ALLOW_ORIGINS", default=["*"])
